// ----------------------------------------------------------------------
// <copyright file="IShadowProjectGenerateService.cs" company="SoloX Software">
...
{
    /// <summary>
    /// IShadowProjectGenerateService interface to generate a shadow project file.
    /// </summary>
    public interface IShadowProjectGenerateService
    {
        /// <summary>
